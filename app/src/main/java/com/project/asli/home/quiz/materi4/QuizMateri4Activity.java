package com.project.asli.home.quiz.materi4;
...
import com.project.asli.databinding.ActivityQuizMateri4Binding;
...
public class QuizMateri4Activity extends AppCompatActivity {

    private ActivityQuizMateri4Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuizMateri4Binding.inflate(getLayoutInflater());
        ...
        binding.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuizMateri4Activity.this, QuizAddActivity.class);
                intent.putExtra(QuizAddActivity.TYPE, "quiz_4");
        ...
        binding.prevBtn.setOnClickListener(view -> {
            ...
            switch (ans) {
                case "A":
                    binding.a.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
                    break;
                case "B":
                    binding.b.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
                    break;
                case "C":
                    binding.c.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
                    break;
                case "D":
                    binding.d.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
                    break;
            }
        });
        ...
        binding.editBtn.setOnClickListener(view -> {
            Intent intent = new Intent(QuizMateri4Activity.this, QuizEditActivity.class);
            ...
            intent.putExtra(QuizEditActivity.TYPE, "quiz_4");
            startActivity(intent);
        });
        ...
        binding.finishBtn.setOnClickListener(view -> {
            ...
            new AlertDialog.Builder(QuizMateri4Activity.this)
                    ...
                    .setPositiveButton("YA", (dialogInterface, ii) -> {
                        ...
                        Intent intent = new Intent(QuizMateri4Activity.this, QuizResultActivity.class);
                        ...
                        intent.putExtra(QuizResultActivity.TYPE, "4");
                        startActivity(intent);
        ...
        binding.standard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(QuizMateri4Activity.this, QuizStandardActivity.class);
                intent.putExtra(QuizStandardActivity.EXTRA_TYPE, "4");
    ...
    private void answerChoice() {
        binding.a.setOnClickListener(view -> {
            ans = "A";
            binding.a.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
            binding.b.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
            binding.c.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
            binding.d.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
        });

        binding.b.setOnClickListener(view -> {
            ans = "B";
            binding.a.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
            binding.b.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, android.R.color.holo_green_dark));
            binding.c.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
            binding.d.setBackgroundTintList(ContextCompat.getColorStateList(QuizMateri4Activity.this, R.color.background));
        });
